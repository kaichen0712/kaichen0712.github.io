...
if (!Array.prototype.map)
  Array.prototype.map = function (t) {
    ...
    for (var n = 0; n < e; ++n)
      if (n in this)
        i[n] = r ? t.call(r, this[n], n, this) : t(this[n], n, this);
    return i;
  };
...
if (!Date.prototype.toISOString)
  Date.prototype.toISOString = (function () {
    ...
    return function e() {
      ...
      return (
        [r, t(this.getUTCMonth() + 1), t(this.getUTCDate())].join("-") +
        "T" +
        [
          t(this.getUTCHours()),
  ...
  try {
    ...
    function t(t) {
      ...
      for (var r = 0; r < t.length; r += 2)
        e.push(String.fromCharCode(parseInt(t.slice(r, r + 2), 16)));
      var i = e.join("");
      return i;
    }
    return function (e) {
